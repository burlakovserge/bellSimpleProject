...
INSERT INTO Person (id, first_name, second_name, middle_name, phone, work_position, doc_number, doc_date,
    is_identified, office_id)
VALUES (1, 'Пономарев', 'Дмитрий', 'Леонидович', '+79991112323', 'Генеральный директор', '1810123123', '2010-07-01',
  1,1);
...
INSERT INTO Person_Document (person_id, document_id) VALUES (1, 1), (1, 4);
INSERT INTO Person_Citizenship (person_id, citizenship_id) VALUES (1, 2);